...
const ServiceDetail = () => {
  ...
  // HELPER: Meta data mapping based on slug
  const getMetaData = (slug) => {
    const metaDataMap = {
      ...
      "ai-virtual-assistants": {
        ...
        focusKeyword: "ai virtual assistant​",
      },
      "seo-content-social": {
        title:
          "AI SEO Agency | SEO Services for Healthcare & Other Business UK",
        description:
          "AI SEO agency offering SEO services for healthcare & other brands to improve rankings, drive traffic, and grow your business.",
        focusKeyword: "ai seo agency​",
      },
      "websites-custom-software": {
        title:
          "Web Development Agency UK | Apps, Portal & Softwares Development",
        description:
        ...
        focusKeyword: "web development agency​",
      },
      "responsible-ai-compliance": {
        ...
        focusKeyword: "ai compliance software",
      },
      "care-agency-recruitment": {
        ...
        focusKeyword: "ai recruitment software",
      },
    };

    return (
      metaDataMap[slug] || {
        title: `${service?.serviceName || "Service"} | Amica Digital`,
        description:
          service?.description ||
          "Professional digital services by Amica Digital",
        focusKeyword: service?.serviceName || "",
      }
    );
  };
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-accent dark:text-gray-200">
      <Helmet>
        ...
        <meta name="keywords" content={metaData.focusKeyword} />
        {/* Optional: Add canonical URL */}
        <link
          rel="canonical"
          href={`https://amicadigitalservices.com/services/${slug}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://amicadigitalservices.com/services/${slug}`}
        />
