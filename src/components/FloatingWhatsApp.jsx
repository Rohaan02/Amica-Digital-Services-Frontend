...
const FloatingWhatsApp = () => {
  ...
  // Phone number in international format (remove spaces and special chars)
  ...
  return (
    ...
    >
      ...
      >
        {/* Button background */}
        <div
          className={`w-16 h-16 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 ${
        ...
        {/* Notification badge (optional - remove if you don't want it) */}
